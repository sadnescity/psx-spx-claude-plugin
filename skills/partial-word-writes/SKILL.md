...
[On-die MMIO behavior](#on-die-mmio-behavior)<br/>
[SBUS behavior](#sbus-behavior)<br/>
[Summary table](#summary-table)<br/>
[Practical implications](#practical-implications)<br/>
[Caveats](#caveats)<br/>
...
- **SBUS** (SPU, CD-ROM, BIOS ROM, DEV0, DEV8) is an off-die
  ...
  [Memory Control](../memory-control/SKILL.md)). CD-ROM and BIOS ROM are
...
[Memory Control](../memory-control/SKILL.md)): an 8-bit device uses
